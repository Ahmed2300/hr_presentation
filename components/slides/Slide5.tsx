...
const Slide5: React.FC<SlideProps> = ({ openFullscreen }) => {
    return (
        <div className="w-full h-full relative overflow-hidden bg-[linear-gradient(135deg,_#5c6bc0_0%,_#3949ab_100%)] text-white">
            <div className="absolute inset-0 bg-[url('https://iili.io/KuGadZv.png')] bg-cover bg-center opacity-10 z-0"></div>
            <AnimatedBackground />
            <div className="relative z-10 flex flex-col h-full p-4 md:p-8 lg:p-10">
                <header className="flex items-center mb-4 md:mb-8">
                    ...
                    <div>
                        <h2 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-white to-indigo-200 text-transparent bg-clip-text">Employee System: Requests & Design</h2>
                ...
                <div className="flex flex-col lg:flex-row flex-grow gap-4 md:gap-8 items-center">
                    <div className="w-full lg:flex-1 flex flex-col gap-3 md:gap-5">
                        <FeatureCard icon="request_page" title="Request Page">
                           <FeatureItem>Monthly quota system</FeatureItem>
                           <FeatureItem>Dynamic forms by request type</FeatureItem>
                           <FeatureItem>Request history with status</FeatureItem>
                        </FeatureCard>
                         <FeatureCard icon="palette" title="Design Features">
                           <FeatureItem>Bootstrap 5 responsive design</FeatureItem>
                           <FeatureItem>Dark/Light mode support</FeatureItem>
                           <FeatureItem>Modern UI with gradient backgrounds</FeatureItem>
                        </FeatureCard>
                    </div>
                    <div className="w-full lg:flex-1 flex flex-col justify-center items-center relative">
                        <ImageWithFullscreen
                            src="https://iili.io/KuGadZv.png"
                            alt="Employee Request System Interface"
                        ...
                        />
                        <div className="mt-2 md:mt-4 text-sm md:text-lg text-center text-indigo-100">Intuitive request forms and themes</div>
                    </div>
                </div>
            </div>
        </div>
